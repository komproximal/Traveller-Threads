...
export const Cta = ({
  className,
  icon = <IconFacebook2 className="icon-instance-node" color="white" />,
  override = <IconInstagram1 className="icon-instance-node" color="white" />,
  icon1 = <IconTwitter2 className="icon-instance-node" color="white" />,
  ...
  return (
    <div className={`CTA ${className}`}>
      ...
      <img className="vuesax-bold-location" alt="Vuesax bold location" src="/img/vuesax-bold-location-1.png" />
    </div>
  );
};
