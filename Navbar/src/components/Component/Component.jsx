...
export const Component = ({ property1, className, fluentLocation = "/img/fluent-location-48-filled-1.svg" }) => {
  return (
    <div className={`component ${property1} ${className}`}>
      <img
        className="fluent-location"
        alt="Fluent location"
        src={property1 === "default" ? fluentLocation : "/img/fluent-location-48-filled-2.svg"}
      />
